...
class UpdateNoRenewalDownloader extends AsyncTask<Void, Integer, Long> {
    ...
    public UpdateNoRenewalDownloader(IDownloadAgent agent, Context context, String url, File file) {
        super();
        mContext = context;
        mAgent = agent;
        mUrl = url;
